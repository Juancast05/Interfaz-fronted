...
@Component({
  selector: 'app-tipo-jornada-pyp-form',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './tipo-jornada-pyp-form.component.html',
  styleUrl: './tipo-jornada-pyp-form.component.css',
})
export class TipoJornadaPypFormComponent implements OnInit {
  tipoJornadaForm!: FormGroup;
      ...
      if (id) {
        ...
        this.service.getById(this.itemId).subscribe({
          ...
          error: (e) => {
            ...
            this.router.navigate(['/catalogos/tipos-jornada-pyp']);
          },
        });
      }
    });
  ...
  onSubmit(): void {
    if (this.tipoJornadaForm.valid) {
      const item: TipoJornadaPyp = this.tipoJornadaForm.value;
      ...
      this.tipoJornadaForm.markAllAsTouched();
    }
  }
