...
@Component({
  selector: 'app-tipo-motivo-pyp-form',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './tipo-motivo-pyp-form.component.html',
  styleUrl: './tipo-motivo-pyp-form.component.css',
})
export class TipoMotivoPypFormComponent implements OnInit {
  tipoMotivoPypForm!: FormGroup;
  ...
  ngOnInit(): void {
    this.tipoMotivoPypForm = this.fb.group({
      idTipoMotivoPyp: [null],
      nombre: ['', Validators.required],
      descripcion: ['', Validators.required],
      prioridad: [null, Validators.min(0)],
      fechaRegistra: [null],
      fechaInactiva: [null],
        ...
        this.service.getById(this.itemId).subscribe({
          next: (data) => {
            ...
            const fechaInactiva = data.fechaInactiva
              ...
              : null;
            this.tipoMotivoPypForm.patchValue({
              ...data,
              fechaRegistra,
              fechaInactiva,
            });
          ...
          error: (e) => {
            ...
            this.router.navigate(['/catalogos/tipos-motivo-pyp']);
          },
        });
      }
    });
  ...
  onSubmit(): void {
    if (this.tipoMotivoPypForm.valid) {
      const item: TipoMotivoPyp = this.tipoMotivoPypForm.value;
      ...
      this.tipoMotivoPypForm.markAllAsTouched();
    }
  }
